...
<body onload="clearDate();noBack();"
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<h1>
			Opening Stock details <small> View Current year Opening stock <img
						...
						<div id="salesDetailsDiv">
							<table id="example1" class="table table-bordered table-striped">
								<thead>
									<tr>
									   <th><b>SERIAL</b></th>
										<th><b>CURRENT FINANCIAL YEAR</b></th>
										<th><b>ITEM IDS</b></th>
										<th><b>QTY</b></th>
<!-- 										<th><b>ALTER QTY</b></th> -->
<!-- 										<th><b>REMARKS</b></th> -->
...
<%-- 												<td><input type="text" name="alterQty" id="alterqty<%=k %>" value="<s:property value="stockManupulation" />"/></td> --%>
<%-- 												<td><input type="text" name="remarks" placeholder="Enter your remarks" id="remarks<%=k %>" value="<s:property value="remarks" />"  /></td> --%>
